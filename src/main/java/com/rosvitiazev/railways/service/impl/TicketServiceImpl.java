...
public class TicketServiceImpl implements TicketService {
    ...
    @Override
    public boolean existsByPassengerTrainId(String firstName, String lastName, Long trainId) {
        return ticketRepository.existsByPassengerFirstNameAndPassengerLastNameAndTrainId(firstName, lastName, trainId);
    }
